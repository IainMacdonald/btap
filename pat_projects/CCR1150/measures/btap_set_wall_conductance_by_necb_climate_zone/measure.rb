...
class BTAPSetWallConductanceByNecbClimateZone < OpenStudio::Ruleset::ModelUserScript
  ...
  def name
    return "BTAPSetWallConductanceByNecbClimateZone "
  end

  def description
    return "Modifies wall conductances by climate zone."
  end
  ...
  def run(model, runner, user_arguments)
    ...
    puts "-------------------------hdd18-------------------------------------------------------------"
    puts  data['hdd18']
    runner.registerInfo("-------------------------hdd18-------------------#{data['hdd18']}-----------------------------------")
...
BTAPSetWallConductanceByNecbClimateZone.new.registerWithApplication
